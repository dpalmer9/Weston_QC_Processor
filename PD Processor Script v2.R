...
bad.list$bad.app.wt = c(' w', 'w','C57Bl6') #8 
bad.list$bad.app.tg = c(' t', 't', 'APP-PS1') #9
bad.list$bad.5x.wt = c(' w', 'w', 'C57Bl/6j') #10
...
qc.data.pretrain.final = qc.data.pretrain.final[ ,c(1:10)]
qc.data.pretrain.final[ ,10] = 1
qc.data.pretrain.final[ ,9] = NULL
...
## Save Raw Data Files ##
write.csv(qc.data.pretrain.agg, "Weston PD Pretrain QC Mar 26 2018.csv")
write.csv(qc.data.acquisition.final, "Weston PD Acquisition QC Mar 26 2018.csv")
write.csv(qc.data.acq.agg, "Weston PD Acquisition Aggregated Mar 26 2018.csv")
write.csv(qc.data.main.lat, "Weston PD Basline Reversal QC Mar 26 2018.csv")
