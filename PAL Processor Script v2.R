...
name.data.main$Age.Months = gsub(7,10,name.data.main$Age.Months)
...
## Save Raw Data Files ##
write.csv(qc.data.pretrain.agg, "Weston PAL Pretraining Mar 26 2018.csv")
write.csv(qc.data.acq.agg, "Weston PAL Acquisition Mar 26 2018.csv")
write.csv(qc.data.acq.agg, "Weston PAL Acquisition Aggregated Mar 26 2018.csv")
write.csv(qc.data.main.lat, "Weston PAL Main Task Mar 26 2018.csv")
write.csv(qc.data.main.agg, "Weston PAL Main Task Aggregated Mar 26 2018.csv")
