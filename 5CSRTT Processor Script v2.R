...
## Save Raw Data Files ##
write.csv(qc.data.pretrain.agg, "Weston 5CSRTT Pretrain QC Mar 26 2018.csv")

write.csv(qc.data.acquisition.final, "Weston 5CSRTT Acquisition QC Mar 26 2018.csv")
write.csv(qc.data.acq.agg, "Weston 5CSRTT Acquisition Aggregated QC Mar 26 2018.csv")

write.csv(qc.data.mainprobe.lat, "Weston 5CSRTT Probe QC Mar 26 2018.csv")
write.csv(qc.data.mainprobe.agg, "Weston 5CSRTT Probe Aggregated QC Mar 26 2018.csv")

write.csv(qc.data.vigilance.averaged.agg, "Weston 5CSRTT Probe Aggregated Vigilance AVERAGED METHOD Mar 26 2018.csv")
write.csv(qc.data.vigilance.last.agg, "Weston 5CSRTT Probe Aggregated Vigilance LAST METHOD QC Mar 26 2018.csv")
write.csv(qc.data.vigilance.blocked.agg, "Weston 5CSRTT Probe Aggregated Vigilance BLOCK BY BLOCK METHOD QC Mar 26 2018.csv")
